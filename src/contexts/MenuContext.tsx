...
interface MenuContextType {
  ...
  getPublicMenu: (restaurantSlug?: string) => { categories: MenuCategory[]; products: MenuProduct[] };
...
export function MenuProvider({ children }: { children: React.ReactNode }) {
  ...
  const initializeMenuData = () => {
    ...
    const mockProducts: MenuProduct[] = [
      ...
      },
      {
        ...
        order: 2,
        variations: [
          { id: '1', name: 'Pequena', price: 42.90, isDefault: false },
          { id: '2', name: 'Média', price: 52.90, isDefault: true },
          { id: '3', name: 'Grande', price: 62.90, isDefault: false }
        ],
        tags: ['Picante']
      },
      {
        ...
        order: 1,
        variations: [
          { id: '1', name: 'Simples', price: 32.90, isDefault: true },
          { id: '2', name: 'Duplo', price: 42.90, isDefault: false }
        ],
        extras: [
      ...
      },
      {
        ...
        variations: [
          ...
          { id: '4', name: 'Fanta', price: 6.50, isDefault: false }
        ],
        tags: ['Gelado']
      },
      {
  ...
  const generateQRCode = (tableNumber: string): string => {
    ...
    return `${window.location.origin}/menu/${restaurantSlug}?table=${tableNumber}`;
  };
