...
import WhiteLabelHeader from '../WhiteLabel/WhiteLabelHeader';
        ...
        <nav className="mt-6 px-3">
          ...
          {navigation.map((item) => (
            <NavLink
              ...
              to={item.href}
              className={({ isActive }) =>
                `group flex items-center px-3 py-2 text-sm font-medium rounded-lg mb-1 transition-colors duration-200 ${
                  isActive
