...
function PublicMenu() {
  ...
  const calculateDeliveryFee = (zipCode: string) => {
    // Simulação de cálculo de taxa de entrega
    const fees = {
    ...
    return fees[prefix as keyof typeof fees] || { fee: 12.90, time: 60 };
  };
  ...
  const getPointsToNextLevel = () => {
    const thresholds = { bronze: 0, silver: 100, gold: 300 };
