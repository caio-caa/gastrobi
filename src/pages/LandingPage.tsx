        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl">
              Sistema completo de gestão com cardápio digital, POS, fidelidade, marketing e relatórios. 
              Aumente suas vendas em até 40% e economize 5 horas por dia.
            </p>
          ...
          <div className="relative">
            ...
            ></div>
            <div 
              className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full opacity-20 animate-pulse delay-1000"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Uma plataforma completa que integra todas as operações do seu restaurante, 
            desde o cardápio digital até relatórios avançados de vendas.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.filter(feature => {
            // Filtrar features baseado na configuração white label
            if (feature.title === 'Sistema POS Completo') return config.features.pos;
            if (feature.title === 'Programa de Fidelidade') return config.features.loyalty;
            if (feature.title === 'Marketing Inteligente') return config.features.campaigns;
            if (feature.title === 'Relatórios Avançados') return config.features.reports;
            if (feature.title === 'Cardápio Digital') return config.features.qrCodes;
            return true;
          }).map((feature, index) => (
            <div 
              key={index}
              className="group p-8 rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300"
              style={{ 
                borderColor: 'transparent',
                '--hover-border-color': config.primaryColor 
              }}
              onMouseEnter={(e) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8">
              Nossos clientes veem resultados reais em poucas semanas. 
              Veja como o {config.brandName} pode transformar seu negócio.
            </p>
