  ...
  const handleSendCampaign = (campaignId: string) => {
    ...
    if (campaign) {
      updateCampaign(campaignId, {
        ...
        openRate: Math.floor(Math.random() * 30) + 60, // Simula taxa de abertura
        clickRate: Math.floor(Math.random() * 15) + 15, // Simula taxa de clique
        redeemRate: Math.floor(Math.random() * 10) + 5 // Simula taxa de resgate
      });
    }
  };
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {newCampaign.message.length}/500 caracteres
            </p>
          </div>
          ...
          <div>
            ...
            >
              ...
              <option value="sent">Enviar agora</option>
            </select>
          </div>
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            <Button onClick={handleCreateCampaign}>
              {newCampaign.status === 'sent' ? 'Enviar Campanha' : 'Salvar Campanha'}
            </Button>
          </div>
        </div>
      </Modal>
