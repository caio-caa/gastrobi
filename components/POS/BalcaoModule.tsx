  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        ...
        {/* Mobile Categories */}
        <div className="bg-white p-4 border-b border-gray-100 sticky top-16 z-30">
                  ...
                  {products
                    ...
                    .map((product) => (
                      <button
                        key={product.id}
                        onClick={() => addToCart(product)}
                        className="p-4 border border-gray-100 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors text-left"
                      >
