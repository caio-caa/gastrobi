...
function DeliveryModule() {
  ...
  const [step, setStep] = useState<'customer' | 'products' | 'review'>(
    'customer'
  );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateCustomer('neighborhood', e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  >
                    ...
                    {neighborhoods.map((neighborhood) => (
                      <option key={neighborhood} value={neighborhood}>
                        {neighborhood} -{' '}
                        {formatCurrency(calculateDeliveryFee(neighborhood))}
                      </option>
                    ))}
                  </select>
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCustomer('complement', e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    ...
                    {products
                      ...
                      .map((product) => (
                        <button
                          ...
                          className="p-3 border border-gray-100 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors text-left"
                        >
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  <p className="dark:text-zinc-300">
                    <strong>Nome:</strong> {currentOrder.customer.name}
                  </p>
                  <p className="dark:text-zinc-300">
                    <strong>Telefone:</strong> {currentOrder.customer.phone}
                  </p>
                  <p className="dark:text-zinc-300">
                    <strong>Endereço:</strong> {currentOrder.customer.address}
                  </p>
                  <p className="dark:text-zinc-300">
                    <strong>Bairro:</strong> {currentOrder.customer.neighborhood}
                  </p>
