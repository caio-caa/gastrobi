...
export default function SettingsPage() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: user?.email || 'joao@restaurante.com',
    phone: '(11) 98888-7777',
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-blue-700">
                Recursos avançados de BI e campanhas ilimitadas
              </p>
            ...
            <div className="text-right mt-4 lg:mt-0">
              ...
              <p className="text-sm text-blue-700 mt-1">Próxima cobrança: 15/01/2025</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr>
                <td className="px-6 py-4 text-sm text-gray-900">15/12/2024</td>
              ...
              <tr>
                <td className="px-6 py-4 text-sm text-gray-900">15/11/2024</td>
                <td className="px-6 py-4 text-sm text-gray-900">Plano Premium - Novembro</td>
                <td className="px-6 py-4 text-sm text-gray-900">R$ 97,00</td>
                <td className="px-6 py-4">
                  <span className="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                    Pago
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-500">Último backup: 14/12/2024 às 03:00</p>
            </div>
            <Button variant="outline">
              Fazer Backup
            </Button>
